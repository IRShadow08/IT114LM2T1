...
<body>
    ...
    <form runat="server">
        ...
        <asp:Label ID="Song" runat="server" Text="Young Love - Air Supply"></asp:Label>
        ...
        <asp:Image ID="CoverAlbum" runat="server" ImageUrl="https://i.ytimg.com/vi/U7H6XEJvecY/maxresdefault.jpg" Width="200" Height="200" />
        ...
        <asp:Button ID="Prevbtn" runat="server" Text="Prev" />
        <asp:Button ID="Playbtn" runat="server" Text="Play" OnClick="Playbtn_Click" />
